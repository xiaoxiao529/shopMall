<template>
	<div id="prompt" v-if="ifMaxBuyNumber">
	    ...
	    <div class="clear module-dialog module-dialog-confirm module-dialog-show" style="display: block; opacity: 1;">
	      <div class="dialog-panel">
	        <div class="topbar">
	          ...
	          <span class="dialog-close png" @click="hidePromptHandle()"></span>
	        </div>
...
export default{
	computed:{
		ifMaxBuyNumber(){
			return this.$store.state.ifMaxBuyNumber
		}
	},
	methods:{
		hidePromptHandle(){
